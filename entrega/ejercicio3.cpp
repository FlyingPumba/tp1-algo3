...
int aux_resolver(Tablero& p, Coord anterior, int cant_caballos, Tablero& t_optimo, int c_optimo, Tablero& original, int cant_caballos_original);
...
int resolver(Tablero& p, int cant_caballos) {
    ...
    Coord principio(0, 0);
    int n = p.size();
    int sol = aux_resolver(p, principio, cant_caballos, optimo, cota, original, cant_caballos);
 ...
 */
int aux_resolver(Tablero& p, Coord actual, int cant_caballos, Tablero& t_optimo, int c_optimo, Tablero& original, int cant_caballos_original) {
    int n = p.size();
    //Poda caso S
    ...
    if (caso_B || caso_C) {
        ...
        int sol = aux_resolver(p, proxima_coordenada(p,actual), cant_caballos+1, t_optimo, c_optimo, original, cant_caballos_original);
    ...
    if (caso_A || caso_D) {
        ...
        return aux_resolver(p, proxima_coordenada(p,actual), cant_caballos, t_optimo, c_optimo, original, cant_caballos_original);
    }
    ...
    int sol1 = aux_resolver(p, proxima_coordenada(p,actual), cant_caballos, t_optimo, c_optimo, original, cant_caballos_original);
    ...
    int sol2 = aux_resolver(p, proxima_coordenada(p,actual), cant_caballos+1, t_optimo, sol1, original, cant_caballos_original);
